...
public class EventosResAdaptador extends RecyclerView.Adapter<EventosResAdaptador.ViewHolder>{
    Context context;
    ArrayList<Evento> list  = new ArrayList<>();
    ClickListnerForRecyclerView clickListnerForRecyclerView;

    public EventosResAdaptador(Context context, ArrayList<Evento> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.inflator_para_eventos_res, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.txt_codigo.setText("Código: " + evento .codigo);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView txt_name, txt_localizacao, txt_codigo, txt_description, txt_data_i, txt_data_f, txt_preco_normal, txt_preco_vip;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            btn_cancelar = (Button)itemView.findViewById(R.id.home_btn_cancelar);
            ...
            txt_codigo = (TextView)itemView.findViewById(R.id.home_txt_codigo);
