...
public class EventosGestorAdaptador extends RecyclerView.Adapter<EventosGestorAdaptador.ViewHolder>{
    Context context;
    ArrayList<Evento> list  = new ArrayList<>();
    ClickListnerForRecyclerView clickListnerForRecyclerView;

    public EventosGestorAdaptador(Context context, ArrayList<Evento> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.inflator_para_eventos_gestor, parent, false);
